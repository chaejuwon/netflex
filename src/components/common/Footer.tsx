  ...
  return (
    <FooterWrap>
      <FooterGap>
        <FooterContent1>
          <a>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img"
                 viewBox="0 0 24 24" width="24" height="24"
                 data-icon="FacebookStandard" aria-hidden="true"
          ...
          <a>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img"
                 viewBox="0 0 24 24" width="24" height="24"
                 data-icon="InstagramStandard" aria-hidden="true"
          ...
          <a>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img"
                 viewBox="0 0 24 24" width="24" height="24"
                 data-icon="TwitterStandard" aria-hidden="true"
          ...
          <a>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" role="img"
                 viewBox="0 0 24 24" width="24" height="24"
                 data-icon="YoutubeStandard" aria-hidden="true"
